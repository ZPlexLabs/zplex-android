...
import zechs.zplex.feature_auth.BuildConfig
import zechs.zplex.feature_auth.ui.server.ServerFragment.Companion.TAG
            ...
            try {
                ...
                withContext(Dispatchers.IO) {
                    ...
                    try {
                        ...
                        if (code == 200) {
                            apiKeyStorage.saveApiKey(baseUrl.toString())
