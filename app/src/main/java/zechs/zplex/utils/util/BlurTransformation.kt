// Source:
// https://github.com/Commit451/coil-transformations/blob/main/transformations/src/main/java/com/commit451/coiltransformations/BlurTransformation.kt
// Merged with https://github.com/Commit451/coil-transformations/pull/12
 ...
 *
 * @param radius The radius of the blur. Must be in the range [1, 25].
...
data class BlurTransformation @JvmOverloads constructor(
    ...
    override suspend fun transform(input: Bitmap, size: Size): Bitmap {
        ...
        val output = createBitmap(scaledWidth, scaledHeight, input.config ?: Bitmap.Config.ARGB_8888)
        output.applyCanvas {
