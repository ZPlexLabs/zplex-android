...
class DriveRepository @Inject constructor(
    ...
    suspend fun getFiles(
        ...
        val tokenResponse = tokenStore.fetchAccessToken()
    ...
    suspend fun fetchRefreshToken(
        ...
        return try {
            ...
            driveClientStore.get().save(client)
            tokenStore.saveRefreshToken(token.refreshToken)
            tokenStore.saveAccessToken(token.toTokenResponse())
